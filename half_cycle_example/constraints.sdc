...
create_generated_clock -name CLK_G -source [get_ports clk] -invert -multiply_by 1 [get_ports clk_g]
set_clock_latency -source -clock CLK_G 2.5 [get_ports clk_g]
...
# set_assigned_delay -max -cell  -from _6_/A -to _6_/ZN  5.0 
# set_assigned_delay -max -cell  -from _4_/A -to _4_/Z  1.0 
...
report_checks -path_delay min_max -format full_clock_expanded -fields {slew cap input_pins fanout}  -endpoint_path_count 10 -unique_paths_to_endpoint -digits 4 > ./sta_report.rpt
