...
create_generated_clock -name CLK_G -source [get_ports clk] -multiply_by 2 [get_ports clk_g]
set_clock_latency -source -clock CLK_G 1.5 [get_ports clk_g]

set_multicycle_path -setup 2 -from [get_pins _3_/CK] -to [get_pins _2_/D] -end
set_multicycle_path -hold 1 -from [get_pins _3_/CK] -to [get_pins _2_/D] -end
